...
<body>
    <div class="container">
        <h1 class="form-title">Admin Login Form</h1>
        ...
        <!--<div class="signup-container">
            <div class="signup-redirect">
                <p style="font-size: 16px;">Not a Admin? <a href="hk_login.php">Login as staff</a></p>
                <hr style="margin: 10px;">
                <p>Or back to <a href="user_login.php">Login as user</a></p>
            </div>
        </div>-->
        <div class="signup-container">
            <div class="signup-redirect">
                <p>Not a Admin? <a href="hk_login.php">Login as Staff</a></p>
            </div>
            <div class="line"></div>
